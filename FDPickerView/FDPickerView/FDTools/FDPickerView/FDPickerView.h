...
#import "FDPickerViewConfig.h"

NS_ASSUME_NONNULL_BEGIN

typedef NS_ENUM(NSInteger, FDPickerContentMode) {
    FDPickerContentModeBottom, // 1.选择器在视图的下方
    FDPickerContentModeCenter  // 2.选择器在视图的中间
};
@interface FDPickerView : UIButton
/** 1.内部视图 */
...
/** 6.视图的显示模式 */
@property (nonatomic, assign)FDPickerContentMode contentMode;
