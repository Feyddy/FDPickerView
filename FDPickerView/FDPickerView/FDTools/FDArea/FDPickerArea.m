...
@interface FDPickerArea()<UIPickerViewDataSource, UIPickerViewDelegate>
...
{
    if (!_arrayRoot) {
        NSString *path = [[NSBundle bundleForClass:[FDPickerView class]] pathForResource:@"area" ofType:@"plist"];
